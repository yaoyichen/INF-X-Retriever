...
@torch.no_grad()
def retrieval_sf_qwen_e5_inf(queries,query_ids,documents,doc_ids,task,model_id,instructions,cache_dir,excluded_ids,long_context,**kwargs):
    if model_id=='inf':
...
RETRIEVAL_FUNCS = {
    'inf': retrieval_sf_qwen_e5_inf,
    'sf': retrieval_sf_qwen_e5_inf,
    'qwen': retrieval_sf_qwen_e5_inf,
    'qwen2': retrieval_sf_qwen_e5_inf,
    'e5': retrieval_sf_qwen_e5_inf,
    'bm25': retrieval_bm25,
